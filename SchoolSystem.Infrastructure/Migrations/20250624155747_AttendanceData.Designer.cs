...
namespace SchoolSystem.Infrastructure.Migrations
{
    ...
    [Migration("20250624155747_AttendanceData")]
    partial class AttendanceData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SchoolSystem.Infrastructure.Models.Attendance", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            StudentId = new Guid("10101010-1010-1010-1010-101010101010"),
            ...
            modelBuilder.Entity("SchoolSystem.Infrastructure.Models.Grade", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("11111111-1111-1111-1111-111111111111"),
                            GradeDate = new DateTime(2025, 1, 15, 0, 0, 0, 0, DateTimeKind.Utc),
                            GradeValue = 5,
                            StudentId = new Guid("10101010-1010-1010-1010-101010101010"),
                            SubjectId = new Guid("a1b2c3d4-e5f6-4789-8abc-111111111111")
                        },
                        ...
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            GradeDate = new DateTime(2025, 2, 20, 0, 0, 0, 0, DateTimeKind.Utc),
                            GradeValue = 4,
                            StudentId = new Guid("10101010-1010-1010-1010-101010101010"),
                            SubjectId = new Guid("a1b2c3d4-e5f6-4789-8abc-111111111111")
                        },
                        ...
                        {
                            Id = new Guid("33333333-3333-3333-3333-333333333333"),
                            GradeDate = new DateTime(2025, 3, 25, 0, 0, 0, 0, DateTimeKind.Utc),
                            GradeValue = 6,
                            StudentId = new Guid("10101010-1010-1010-1010-101010101010"),
                            SubjectId = new Guid("a1b2c3d4-e5f6-4789-8abc-111111111111")
                        });
